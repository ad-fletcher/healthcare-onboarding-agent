...
from helpers.prompts import INSTRUCTION_Long
import logging # Add logging import

logger = logging.getLogger(__name__) # Add logger instance

class AssistantLong(Agent):
    def __init__(self, context: RunContext[MySessionInfo]): # Removed chat_ctx parameter
        ...
        super().__init__(instructions=INSTRUCTION_Long) # Consider if INSTRUCTION needs context
